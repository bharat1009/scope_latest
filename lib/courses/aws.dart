...
class AWSPage extends StatefulWidget {
  ...
  @override
  State<AWSPage> createState() => _AWSPageState();
}

class _AWSPageState extends State<AWSPage> {
  List courses=[
    "Introduction of Cloud Computing",
    "Introduction of AWS, Elastic Compute Cloud (Ec2)",
    "Managing Ec2 Instances",
    "Management of Elastic Block Storage",
   " Configuring Elastic Load Balancing, Auto Scaling, Network & Security",
    "Managing Amazon Virtual Private Cloud (VPC)",
    "Amazon Route 53",
    "Setup of Storage and Content Delivery Services",
    "Managing Security and Identity Management Services",
    "Managing Database Services",
    "Management Tools-Cloud Watch, Cloud Formation",
    "Managing Application Services-SES, SQS, SNS",
    "Live deployment",
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("AWS Certified Solutions Architect Associate Internship",
