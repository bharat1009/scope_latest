...
class _AzurePageState extends State<AzurePage> {
  List courses=[
    ...
    "Deploying Webserver Engines – Apache and IIS",
    "Availability Sets, Availability Zones",
    "Azure Virtual Machines - Data Disks",
    "Creating a Storage Account, Azure Storage Explorer",
    "Azure File Shares, Azure File Sync and RSV Deletion",
    "Azure Backup Service - Snapshot and RSV",
    "Azure VM Backup, Restore VM, MARS Agent Configuration",
    "Azure App Services and Deploying a .NET Based Application",
    "Configure and Managing Virtual Networks in Azure Platform",
    "Azure Load Balancer Service and Azure Application Gateway",
    "Jump Server and Bastion Host Configuration",
    "Azure Firewall, and Azure DNS",
    "Azure Entra ID, Azure Entra ID Users and Group Management",
    "Manage Azure Subscriptions, Azure AD Roles",
    "Azure AD Custom Domains",
    "RBAC and Custom Roles in Azure",
    "Migration (On-Premises Active Directory to Azure Entra ID)",
   "Container Concepts and Containerization Using Docker",
    "Live project",
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("Azure Cloud Administrator Internship",
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('40hrs course + 1 month on the Job Training',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
