...
class DaatasciencePage extends StatefulWidget {
  const DaatasciencePage({super.key});

  @override
  State<DaatasciencePage> createState() => _DaatasciencePageState();
}

class _DaatasciencePageState extends State<DaatasciencePage> {
  List courses=[
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('6 months course + 3 months on the Job Training',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
