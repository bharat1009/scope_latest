...
class IonicPage extends StatefulWidget {
  const IonicPage({super.key});

  @override
  State<IonicPage> createState() => _IonicPageState();
}

class _IonicPageState extends State<IonicPage> {
  List courses=[
    "Ionic 5 framework",
    "Cordova/Capacitor",
    "Native API",
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("IONIC - Android - iOS Mobile App Internship",
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('3 months course + 3 months on the Job Training',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
