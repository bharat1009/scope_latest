...
class _JavaPageState extends State<JavaPage> {
   List courses=["JAVA","J2EE","Spring (MVC)","MySQL","HTML 6","CSS 4","Bootstrap 5 / SASS","JavaScript ES 7","JQuery","React JS","Regular Expressions","REST Services","SEO Basics","GIT Version Control","Web Hosting Techniques","Logical Reasoning","Live Projects with Suffix E Solutions","Interview Preparation","OJT","Placement Support"];
            ...
            child: Column(
                  children: [
                    ...
                    Container(
                      child: Column(
                        children: [
                          Text("Java Full Stack Internship",
