...
class MEANPage extends StatefulWidget {
  const MEANPage({super.key});

  @override
  State<MEANPage> createState() => _MEANPageState();
}

class _MEANPageState extends State<MEANPage> {
  List courses=["MongoDB","Express JS","React JS","Node JS","MySQL","CSS 4","Bootstrap 5 / SASS","JavaScript ES 7","JQuery","React JS","Regular Expressions","REST Services","SEO Basics","GIT Version Control","Web Hosting Techniques","Logical Reasoning","Live Projects with Suffix E Solutions","Interview Preparation","OJT","Placement Support"];
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("MEAN Full Stack Internship",
