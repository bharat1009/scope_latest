...
class _PHPPageState extends State<PHPPage> {
  List courses=["PHP 8","Codeigniter 4/Laravel 8","WordPress","MySQL","HTML 6","CSS 4","Bootstrap 5 / SASS","JavaScript ES 7","JQuery","React JS","Regular Expressions","REST Services","SEO Basics","GIT Version Control","Web Hosting Techniques","Logical Reasoning","Live Projects with Suffix E Solutions","Interview Preparation","OJT","Placement Support"];
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("PHP Full Stack Internship",
