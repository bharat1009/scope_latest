...
class _PythonPageState extends State<PythonPage> {
  List courses=["Python 3.12","Django","SQLite","MySQL","HTML 6","CSS 4","Bootstrap 5 / SASS","JavaScript ES 7","JQuery","React JS","Regular Expressions","REST Services","SEO Basics","GIT Version Control","Web Hosting Techniques","Logical Reasoning","Live Projects with Suffix E Solutions","Interview Preparation","OJT","Placement Support"];
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("Python Full Stack Internship",
