...
class RHCEPage extends StatefulWidget {
  const RHCEPage({super.key});

  @override
  State<RHCEPage> createState() => _RHCEPageState();
}

class _RHCEPageState extends State<RHCEPage> {
  List courses=[
    "Introduction of Ansible and automation",
    "Setup of Red Hat Ansible Engine",
    "VControl node and managed node configuration setup",
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("Red Hat Certified Engineer (RHCE) Internship",
