...
class RHCSAPage extends StatefulWidget {
  const RHCSAPage({super.key});

  @override
  State<RHCSAPage> createState() => _RHCSAPageState();
}

class _RHCSAPageState extends State<RHCSAPage> {
  List courses=[
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("Red Hat Certified System Administrator (RHCSA) Internship",
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('100hrs course + 1 month on the Job Training',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
