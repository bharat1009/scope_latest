...
class SoftwareTestingPage extends StatefulWidget {
  const SoftwareTestingPage({super.key});

  @override
  State<SoftwareTestingPage> createState() => _SoftwareTestingPageState();
}

class _SoftwareTestingPageState extends State<SoftwareTestingPage> {
  List courses=[
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('4 months course + 3 months on the Job Training',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
