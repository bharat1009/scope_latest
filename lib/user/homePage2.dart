...
import 'package:scopeindia/user/Courses2.dart';
import 'package:scopeindia/user/aboutUs2.dart';
import 'package:scopeindia/user/contactUs2.dart';
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      await Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context)=>const Courses2()
                          )
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () async {
                      await Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context)=>const Aboutus2()
                          )
                      );
                    },
                  ),
